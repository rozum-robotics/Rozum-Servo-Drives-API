 ...
 * @param Descriptor of the interface where the logged CAN communication occurs (as returned by the ::rr_init_interface function) 
 ...
 * @param stdio stream for saving the debugging log. When the parameter is set to "NULL," logging of debugging events is disabled.
 * @return void
 * @ingroup Utils
 */
 ...
 * 
 * @param Descriptor of the interface (as returned by the ::rr_init_interface function)
 ...
 * @param Error bit field content of the corresponding EMCY message (according to the CanOpen standard)
 * @return void
 * @ingroup Utils
 */
